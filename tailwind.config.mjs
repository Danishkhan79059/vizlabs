...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'custom-gradient': "linear-gradient(135deg, color-mix(in srgb, var(--accent-color), transparent 95%) 50%, color-mix(in srgb, var(--accent-color), transparent 98%) 25%, transparent 50%)",
      },
    },
  },
  plugins: [],
